import ShopReviews from "../../components/organisems/ShopReviews/ShopReviews";
import TopProducts from "../../components/organisems/TopProducts/TopProducts";
import ButtonLayout from "../../layouts/ButtonLayout";

function HomeFragment() {
  return (
    <main className="flex flex-col gap-14 xl:gap-20 pb-14 lg:pb-24">
      <section className="relative h-screen">
        <div className="absolute z-20 w-full px-3 sm:px-14 left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 text-center">
          ...
          <ButtonLayout type="START_SHOPING" />
        </div>
        <img
      ...
      <figure className="xl:grid xl:grid-cols-2 xl:items-center xl:border-t-4 xl:border-b-4">
        <figcaption className="px-5 sm:px-14 text-center">
          ...
          <ButtonLayout type="SELENGKAPNYA" />
        </figcaption>
        <img
      ...
      <section className="px-5 sm:px-10 xl:px-24 2xl:px-40">
      ...
      <section className="xl:mt-10 text-center xl:h-[60vh] xl:grid xl:grid-cols-1 xl:content-center">
        <header>
